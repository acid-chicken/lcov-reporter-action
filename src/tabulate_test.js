...
test("working directory option applies to the file links.", function() {
	const data = [
		{
	...
	const options = {
		...
		commit: "2e15bee6fe0df5003389aa5ec894ec0fea2d874a",
		prefix: "/workspace/",
		workingDirectory: "./packages/project-foo",
	}
		...
		tbody(
			...
			tr(
				td(
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/index.js`,
						},
						"index.js",
					),
				),
			...
			tr(
				td(
					...
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/src/foo.js`,
						},
						"foo.js",
					),
				),
				...
				td(
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/src/foo.js#L37`,
						},
						37,
					),
				),
			...
			tr(
				td(
					...
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/src/bar/baz.js`,
						},
						"baz.js",
					),
				),
				...
				td(
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/src/bar/baz.js#L20-L21`,
						},
						"20&ndash;21",
					),
					", ",
					a(
						{
							href: `https://github.com/${options.repository}/blob/${options.commit}/packages/project-foo/src/bar/baz.js#L27`,
						},
						"27",
					),
				),
